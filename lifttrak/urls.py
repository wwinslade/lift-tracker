...
urlpatterns = [
    ...
    path('guest/routines/<int:template_id>/', views.GuestDisplayWillsRoutinesDetail, name='guest_routines_detail'),
    ...
    path('routines/update/<int:template_id>/', views.UpdateWorkoutTemplate, name='update_routine'),
    path('routines/delete/<int:template_id>/', views.DeleteWorkoutTemplate, name='delete_routine'),
